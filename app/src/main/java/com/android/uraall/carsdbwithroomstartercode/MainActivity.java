...
public class MainActivity extends AppCompatActivity {
    ...
    private CarAppDatabase carAppDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carAppDatabase = Room.databaseBuilder(getApplicationContext(),
                CarAppDatabase.class, "CarsDB")
                .build();
    ...
    private class getAllCarsAsyncTask extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            carArrayList.addAll(carAppDatabase.getCarDAO().getAllCars());
            return null;
        }
    ...
    private  class CreateCarAsyncTask extends AsyncTask<Car, Void, Void>{
        ...
        protected Void doInBackground(Car... cars) {
            long id = carAppDatabase.getCarDAO().addCar(cars[0]);


            Car car = carAppDatabase.getCarDAO().getCar(id);
    ...
    private class UpdateCarAsyncTask extends AsyncTask<Car, Void, Void>{
        ...
        @Override
        protected Void doInBackground(Car... cars) {
            carAppDatabase.getCarDAO().updateCar(cars[0]);
            return null;
        }
    }
    ...
    private class DeleteCarAsyncTask extends AsyncTask<Car, Void, Void>{
        ...
        @Override
        protected Void doInBackground(Car... cars) {
            carAppDatabase.getCarDAO().deleteCar(cars[0]);
